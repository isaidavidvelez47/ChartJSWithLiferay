...
/**
 * <p>
 * Clase Java para baseControlRequest complex type.
 * 
 * <p>
...
@XmlType(name = "baseControlRequest", propOrder = { "canal", "identificadorDeTransaccion" })
@XmlSeeAlso({ ConsultarParametrosHerramientasFVControlRequest.class, ConsultarRentaPortafolioControlRequest.class,
		ConsultarSalarioMinimoControlRequest.class, ConsultarEdadPensionControlRequest.class,
		ConsultarDatosGraficaRentabilidadCEControlRequest.class })
